...
def get_default_install_dir() -> Path:
    ...
    Windows: %LOCALAPPDATA%\\AIConversationCLI
    macOS: ~/Library/Application Support/AIConversationCLI
    Linux: ~/.local/share/ai-conversation-cli
    """
    ...
    if platform_info.system == "windows":
        ...
        if local_app_data:
            return Path(local_app_data) / "AIConversationCLI"
        return home / "AppData" / "Local" / "AIConversationCLI"

    if platform_info.system == "macos":
        return home / "Library" / "Application Support" / "AIConversationCLI"

    return home / ".local" / "share" / "ai-conversation-cli"
