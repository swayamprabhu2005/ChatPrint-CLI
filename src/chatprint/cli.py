"""Command-line interface for ChatPrint CLI."""
...
from chatprint import __app_name__, __version__
from chatprint.errors import AIConversationError
...
from chatprint.providers import detect_best_provider, get_provider
...
def inspect(input_path: Path, source: str, debug: bool):
    ...
    try:
        console.print("[bold cyan]ChatPrint Inspection[/bold cyan]")
        console.print("[dim]────────────────────────────────────────[/dim]")
...
def doctor(verbose: bool):
    """Run comprehensive system health checks for ChatPrint CLI."""
    console.print("[bold cyan]ChatPrint CLI Doctor[/bold cyan]\n")
